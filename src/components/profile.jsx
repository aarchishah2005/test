...
const BackgroundProfile = () => {
  const sections = [
    ...
    },
    {
      ...
      {
      title: 'Specialization',
      content: "Join me and Enrich Your Financial Quotient, master Fearless Financial Investment, and dive into Fearless Financial Trading – because financial freedom should never be a fear, it should be a way of life."
    }
