...
const ContactForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      'service_zlgiip7', // Replace with your EmailJS service ID
      'template_cmi044s', // Replace with your EmailJS template ID
      templateParams,
      'WPUTadb7L4T-o-gXu' // Replace with your EmailJS public key
    )
      .then((response) => {
