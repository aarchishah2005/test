        ...
        <div className="form-header">
          ...
          <ul className="secrets-list">
            <li>
              ...
              <span><span className="secret-number">Secret 1:</span> The Simple Way to Build a Strong Financial Base — Even If You’ve Always Avoided Numbers </span>
            ...
            <li>
              <span className="checkmark">✓</span>
              <span><span className="secret-number">Secret 2:</span>Use a Proven Investment Strategy That Works — No Experience Needed </span>
            </li>
            <li>
              <span className="checkmark">✓</span>
              <span><span className="secret-number">Secret 3:</span>How to Start Earning from the Stock Market Part-Time — While Keeping Your Job or Business </span>
            </li>
          </ul>
        </div>
